...
- Confirm summary JSON is parseable, single-line, and includes required keys (`统计`), except for irrelevant-image samples which remain `summary: 无关图片`.
