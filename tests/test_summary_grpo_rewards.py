...
def test_summary_category_recall_reward_partial_overlap():
    ...
    meta = {"_fusion_source": "rru_summary", "_fusion_template": "summary_rru", "summary_ref": ref}
...
def test_summary_structured_content_tversky_reward_missing_vs_spurious():
    ...
    meta = {"_fusion_source": "bbu_summary", "_fusion_template": "summary_bbu", "summary_ref": ref}
...
def test_summary_notes_bbu_reward_recall_and_spurious_penalty():
    ...
    ref_empty = '{"统计":[]}'
    meta_empty = {"_fusion_source": "bbu_summary", "_fusion_template": "summary_bbu", "summary_ref": ref_empty}
