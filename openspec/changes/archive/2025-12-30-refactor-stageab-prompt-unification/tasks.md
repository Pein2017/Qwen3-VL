...
- [x] Update docs: docs/training/REFERENCE.md, docs/runtime/STAGE_A_STAGE_B.md, docs/reference/stage-B-knowledge-Chinese.md (and adjust prompt references/description).
