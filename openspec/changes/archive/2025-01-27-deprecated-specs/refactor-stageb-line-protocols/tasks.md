...
- [x] Update docs (`docs/runtime/STAGE_B_RUNTIME.md`, `docs/training/REFERENCE.md`, `docs/reference/stage-B-knowledge-Chinese.md`) to describe the new protocols and clarify that storage remains JSONL.
