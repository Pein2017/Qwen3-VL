...
6. **Export**: `export_trajectories`/`export_selections` capture outcomes with warning flags so operators can identify tickets that may need manual跟进。
