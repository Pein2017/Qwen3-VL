...
- Helper script: scans `data/irrelevant_summary/images/*.jpeg`, writes `data/irrelevant_summary/train.jsonl`, keeping filenames and EXIF-aware dimensions; sorts paths deterministically and skips files that fail to load.
