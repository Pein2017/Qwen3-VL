...
- Need a lightweight "irrelevant" source dataset that always yields summary `无关图片` to regularize hallucinations.
- Keep the existing summary template/prompt pipeline intact while adding a clean source stream.
