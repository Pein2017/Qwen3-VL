...
- [ ] Confirm the canonical location and filename for the Schema Constitution (`docs/reference/SCHEMA_CONSTITUTION.md`).
...
- [ ] Update `docs/README.md` and section indices (including `docs/reference/README.md`) to include the new constitution and checklist references.
