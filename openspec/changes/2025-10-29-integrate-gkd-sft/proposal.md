...
- **KD telemetry**: log KD/CE terms per step to flag drift and provide quick health checks (`train/loss`, `train/sft_loss`, `train/llm_kd_loss`, `train/vision_kd_loss`, `train/token_acc`, plus `eval/*` mirrors).
