...
adapters=output/1-21/grpo_summary_1024_attr_key_recall/v3-20260121-161514/attr_key_recall-retry_v2/checkpoint-1600
...
output_dir=output/1-21/grpo_summary_1024_attr_key_recall-v2-merged/ckpt_1600
