...
swift export \
    ...
    --adapters output/stage_2_llm_lora/regularized/v2-20251020-104112/lora_8_16-lr_1e-5-eff_batch-32/checkpoint-2 \
    --merge_lora true \
    --output_dir output/stage_2_merged/checkpoint-2 \
